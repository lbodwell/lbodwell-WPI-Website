...
// TODO: remove global variables and functions and encapsulate into single var

function generateStars() {
	//TODO: implement me
}

function determineFireworkColor() {
	//TODO: implement me
}
...
function explode(x, y) {
	PS.color(PS.COLOR_BLACK);
}

function tick(x) {
	console.log(particlesX + "\n" + particlesY);
	var len, i, x, y;
	len = particlesX.length;
	// TODO: re-work to go in 8 directions instead of 1, leave trail and change colors the farther a particle goes
	while (i < len) {
		x = particlesX[i];
		y = particlesY[i];
		//TODO: calculate beads travelled
		let beadsTravelled = 0;
		if (y < 15 || beadsTravelled > 7) {
...
PS.touch = function(x, y, data, options ) {
	"use strict"; // Do not remove this directive!
	var color = determineFireworkColor();
	// Comment out
